...
using SwerveDrive = ctre::phoenix6::swerve::SwerveDrivetrain<
...
// Updated with team3045 hardware constants
class TunerConstants {
    ...
    static constexpr std::string_view kCANBusName = "team3045";
...
private:
    ...
    static constexpr int kPigeonId = 10;
...
private:
    ...
    static constexpr units::inch_t kFrontLeftXPos = 8.875_in;
    static constexpr units::inch_t kFrontLeftYPos = 12.875_in;
    ...
    static constexpr units::inch_t kFrontRightXPos = 8.875_in;
    static constexpr units::inch_t kFrontRightYPos = -12.875_in;
    ...
    static constexpr units::inch_t kBackLeftXPos = -8.875_in;
    static constexpr units::inch_t kBackLeftYPos = 12.875_in;
    ...
    static constexpr units::inch_t kBackRightXPos = -8.875_in;
    static constexpr units::inch_t kBackRightYPos = -12.875_in;
...
public:
    ...
    /**
     * \brief Constructs a CTRE SwerveDrivetrain using the specified constants and frequency.
     */
    template <std::same_as<SwerveModuleConstants>... ModuleConstants>
    ...
    /**
     * \brief Constructs a CTRE SwerveDrivetrain using specified constants, frequency, and standard deviations.
     */
    template <std::same_as<SwerveModuleConstants>... ModuleConstants>
    TunerSwerveDrivetrain(
        swerve::SwerveDrivetrainConstants const &driveTrainConstants,
