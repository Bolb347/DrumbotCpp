...
frc::Translation3d RobotContainer::scoreTargetBlue{4.57_m, 4.0228_m, 1.2_m};
frc::Translation3d RobotContainer::scoreTargetRed {11.93_m, 4.0228_m, 1.2_m};
...
void RobotContainer::ConfigureBindings() {
    ...
    drivetrain->SetDefaultCommand(drivetrain->ApplyRequest([this]() {
        return m_drive
            ...
            .WithDeadband(units::meters_per_second_t{0.1 * MaxSpeed})
            .WithRotationalDeadband(units::radians_per_second_t{0.1 * MaxAngularRate})
