...
public:
    ...
    // Zone/shooting-state helpers
    int GetSafeShootZone() const;
    bool IsInHoodDeadzone() const;
    ...
    frc2::CommandPtr PointInOrientation(frc2::CommandPS5Controller* controller,
